...
using TestSetup.Api.Services;
using TestSetup.Application.Exceptions;
using TestSetup.Domain.Exception;

namespace TestSetup.Api.Middleware
{
    public class GlobalExceptionMiddleware : IExceptionHandler
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            var response = exception switch
            {
                ...
                TestSetup.Application.Exceptions.UnauthorizedAccessException unauthorizedEx => ResponseBuilder.Unauthorized(unauthorizedEx.Message),
